  ...
  byLevel: {
    A1: {
      ...
      writing: {
        kind: 'note',
        level: 'A1',
        title: 'Notiz · Erster Arbeitstag',
        parts: [
          { label: 'Vorstellung', de: 'Ich bin … Ich bin neu hier.', en: 'I am … I am new here.' },
          { label: 'Abteilung', de: 'Ich arbeite in der … Abteilung.', en: 'I work in the … department.' },
          { label: 'Frage', de: 'Wo ist …? (Toilette / Pausenraum / Drucker)', en: 'Where is …? (toilet / break room / printer)' },
          { label: 'Hilfe', de: 'Können Sie mir helfen?', en: 'Can you help me?' },
          { label: 'Dank', de: 'Vielen Dank!', en: 'Many thanks!' },
        ],
      },
      challenge:
    ...
    A2: {
      ...
      writing: {
        ...
        level: 'A2',
        title: 'Nachricht · nach dem ersten Tag',
        parts: [
          { label: 'Opener', de: 'Hey! Mein erster Arbeitstag war heute. 😊', en: 'Hey! My first day at work was today.' },
          { label: 'Infos', de: 'Alle Kollegen sind sehr nett. Ich habe heute viel gelernt.', en: 'All colleagues are very nice. I learnt a lot today.', highlight: 'Ich habe heute viel gelernt' },
          { label: 'Detail', de: 'Meine Abteilung ist das Marketing. Meine Ansprechperson ist Sarah.', en: 'My department is Marketing. My contact person is Sarah.' },
    ...
    B2: {
      ...
      writing: {
        kind: 'email-formal',
        level: 'B2',
        title: 'E-Mail · Feedback-Gespräch anfragen',
        to: 'thomas.krause@firma-beispiel.de',
        subject: 'Anfrage: Kurzes Feedback-Gespräch nach der ersten Woche',
        parts: [
          { label: 'Anrede', de: 'Sehr geehrter Herr Krause,', en: 'Dear Mr Krause,' },
          { label: 'Anliegen',
            de: 'die erste Woche hat mir sehr gut gefallen und ich bin bereits mit mehreren Projekten in Berührung gekommen. Um sicherzustellen, dass ich die richtigen Prioritäten setze, würde ich mich über ein kurzes Feedback-Gespräch freuen.',
            en: 'I very much enjoyed the first week and have already been in contact with several projects. To make sure I am setting the right priorities, I would welcome a short feedback meeting.',
            highlight: 'würde ich mich über ein kurzes Feedback-Gespräch freuen' },
          { label: 'Bitte',
            de: 'Wäre es möglich, dafür zwanzig Minuten in Ihrem Kalender zu finden — am Freitagnachmittag oder wann auch immer es Ihnen passt?',
            en: 'Would it be possible to find twenty minutes in your calendar — on Friday afternoon or whenever suits you?',
            highlight: 'Wäre es möglich' },
          { label: 'Dank', de: 'Ich freue mich auf Ihre Rückmeldung.', en: 'I look forward to your response.' },
          { label: 'Gruß', de: 'Mit freundlichen Grüßen\nAmir Karimi', en: 'Kind regards, Amir Karimi' },
        ],
        checklist: [
          'Positive framing before the request',
          'Konjunktiv II: würde ich mich freuen / Wäre es möglich',
          'Flexible offer ("oder wann auch immer")',
          'ob / welche register awareness (indirect tone throughout)',
          'Formal greeting with correct salutation',
        ],
      },
      challenge:
