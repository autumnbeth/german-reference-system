  ...
  byLevel: {
    A1: {
      ...
      dialogue: {
        ...
        level: 'A1',
        lines: [
          { speaker: 'Reisende', speakerGender: 'die',
            de: 'Entschuldigung, wo ist Gleis 3?',
            en: 'Excuse me, where is platform 3?' },
          { speaker: 'Passant', speakerGender: 'der',
            de: 'Gleis 3 ist dort drüben, links.',
            en: 'Platform 3 is over there, on the left.' },
          { speaker: 'Reisende', speakerGender: 'die',
            de: 'Danke! Und wo ist der Automat?',
            en: 'Thank you! And where is the ticket machine?' },
          { speaker: 'Passant', speakerGender: 'der',
            de: 'Der Automat ist am Eingang.',
            en: 'The ticket machine is at the entrance.' },
          { speaker: 'Reisende', speakerGender: 'die',
            de: 'Vielen Dank!',
