  ...
  vocab: [
    ...
    },
    {
      ...
      items: [
        ...
        { gender: 'verb', word: 'fehlen', meaning: 'to be absent', note: 'Buxton fehlt heute.' },
      ],
    },
    {
  ...
  byLevel: {
      ...
      dialogue: {
        ...
        lines: [
          ...
          { speaker: 'Mutter', speakerGender: 'die',
            de: 'Guten Morgen. Mein Sohn Buxton ist krank. Er ist in Klasse 4b.',
            en: 'Good morning. My son Buxton is ill. He’s in class 4b.' },
          { speaker: 'Sekretärin', speakerGender: 'die',
      ...
      dialogue: {
        ...
        lines: [
          ...
          { speaker: 'Vater', speakerGender: 'der',
            de: 'Guten Morgen, hier ist Herr O’Brien. Ich möchte meine Tochter krankmelden — sie hat Bauchschmerzen.',
            en: 'Good morning, this is Mr. O’Brien. I’d like to report my daughter sick — she has a stomachache.' },
          { speaker: 'Sekretärin', speakerGender: 'die',
      ...
      writing: {
        ...
        parts: [
          ...
          { label: 'Entschuldigung',
            de: 'mein Sohn Buxton konnte am 3. und 4. Juli wegen einer Erkältung nicht am Unterricht teilnehmen. Bitte entschuldigen Sie sein Fehlen.',
            en: 'my son Buxton could not attend lessons on July 3rd and 4th because of a cold. Please excuse his absence.',
            highlight: 'Bitte entschuldigen Sie sein Fehlen' },
          { label: 'Gruß', de: 'Mit freundlichen Grüßen\nBeth Wegner', en: 'Kind regards, Beth Wegner' },
        ],
        checklist: [
    ...
    B1: {
      ...
      writing: {
        ...
        parts: [
          { label: 'Nachricht',
            de: 'Liebe Frau Müller, wir sind mit dem Theaterbesuch einverstanden — den unterschriebenen Zettel und das Geld bringt Buxton morgen mit. Eine kurze Frage: Um wie viel Uhr ist die Klasse zurück? Viele Grüße, Beth Wegner',
            en: 'Dear Ms. Müller, we agree to the theatre visit — Buxton will bring the signed form and the money tomorrow. One quick question: what time will the class be back? Best regards, Beth Wegner' },
        ],
      },
    },
    ...
    B2: {
      ...
      dialogue: {
        ...
        lines: [
          { speaker: 'Mutter', speakerGender: 'die',
            de: 'Ich würde gern mit Ihnen über Buxtons Leistungen in Deutsch sprechen — außerhalb des Elternsprechtags.',
            en: 'I’d like to talk to you about Buxton’s performance in German — outside the regular parents’ day.' },
      ...
      writing: {
        ...
        subject: 'Antrag auf Freistellung vom Unterricht — Buxton O’Brien, Klasse 4b',
        parts: [
          { label: 'Anrede', de: 'Sehr geehrte Frau Direktorin Weber,', en: 'Dear Principal Weber,' },
          { label: 'Antrag',
            de: 'hiermit beantrage ich die Freistellung meines Sohnes Buxton vom Unterricht am 12. Mai.',
            en: 'I hereby request that my son Buxton be exempted from lessons on May 12th.',
