  ...
  byLevel: {
    A1: {
      ...
      dialogue: {
        ...
        level: 'A1',
        lines: [
          { speaker: 'Kellner', speakerGender: 'der',
            de: 'Guten Abend! Was möchten Sie?',
            en: 'Good evening! What would you like?' },
          { speaker: 'Gast', speakerGender: 'die',
            de: 'Eine Suppe, bitte.',
            en: 'A soup, please.' },
          { speaker: 'Kellner', speakerGender: 'der',
            de: 'Und was möchten Sie trinken?',
            en: 'And what would you like to drink?' },
          { speaker: 'Gast', speakerGender: 'die',
            de: 'Ein Wasser, bitte.',
            en: 'A water, please.' },
          { speaker: 'Kellner', speakerGender: 'der',
            de: 'Kommt sofort. Guten Appetit!',
          ...
          { speaker: 'Kellner', speakerGender: 'der',
            de: 'Natürlich. Das macht fünf Euro.',
            en: 'Of course. That is five euros.' },
          { speaker: 'Gast', speakerGender: 'die',
