...
export const gespraechMitLehrkraft: Situation = {
  ...
  vocab: [
    ...
    {
      label: 'B1 · Verhalten & Eindruck',
      items: [
        { gender: 'verb', word: 'überfordert sein', meaning: 'to be overwhelmed', note: 'Das Kind ist überfordert. ↔ unterfordert (under-challenged)' },
        { gender: 'verb', word: 'unsicher sein', meaning: 'to be unsure / lack confidence', note: 'Mein Kind ist in Mathe unsicher.' },
        { gender: 'das', word: 'Verhalten', meaning: 'behaviour' },
        { gender: 'die', word: 'Leistung', meaning: 'performance / achievement', plural: 'Leistungen' },
        { gender: 'die', word: 'Konzentration', meaning: 'concentration', note: 'sich konzentrieren auf + A' },
        { gender: 'verb', word: 'sich verbessern', meaning: 'to improve', note: 'Seine Noten haben sich verbessert.' },
        { gender: 'verb', word: 'fleißig', meaning: 'hard-working / diligent (adj.)' },
      ],
    },
    {
      label: 'B2 · Förderung & Gespräch',
      items: [
        { gender: 'der', word: 'Förderbedarf', meaning: 'need for extra support' },
        { gender: 'der', word: 'Lernstand', meaning: 'current learning level', note: 'ein Gespräch über den Lernstand' },
        { gender: 'die', word: 'Empfehlung', meaning: 'recommendation (e.g. for secondary school)', plural: 'Empfehlungen' },
        { gender: 'der', word: 'Elternsprechtag', meaning: 'parent–teacher day', plural: 'Elternsprechtage' },
        { gender: 'die', word: 'Maßnahme', meaning: 'measure / intervention', plural: 'Maßnahmen' },
        { gender: 'verb', word: 'vereinbaren', meaning: 'to agree on / arrange', note: 'konkrete Schritte vereinbaren' },
        { gender: 'verb', word: 'sich austauschen über + A', meaning: 'to exchange views about', note: 'separable: Wir tauschen uns regelmäßig aus.' },
      ],
    },
  ],
  ...
  byLevel: {
    A1: {
      ...
      dialogue: {
        title: 'Dialog · Kurzes Gespräch mit der Lehrerin',
        level: 'A1',
        lines: [
          { speaker: 'Elternteil', speakerGender: 'der',
            de: 'Guten Tag. Ich bin der Vater von Lena.',
            en: 'Good day. I am Lena\'s father.' },
          { speaker: 'Lehrerin', speakerGender: 'die',
            de: 'Guten Tag. Schön, Sie zu treffen.',
            en: 'Good day. Nice to meet you.' },
          { speaker: 'Elternteil', speakerGender: 'der',
            de: 'Wie läuft es in der Schule?',
            en: 'How is it going at school?' },
          { speaker: 'Lehrerin', speakerGender: 'die',
            de: 'Lena ist fleißig und freundlich.',
            en: 'Lena is diligent and friendly.' },
          { speaker: 'Elternteil', speakerGender: 'der',
            de: 'Das ist gut. Danke.',
            en: 'That is good. Thank you.' },
          { speaker: 'Lehrerin', speakerGender: 'die',
            de: 'Gern. Bis zum nächsten Elternabend.',
